...
while not finalizar:
    ...
    if opcion_seleccionada == 'A':
        ...
        print("La simBP entre "+ n_str + " y "+ m_str + " es " + str(simBP(int(n_str), int(m_str))))
        ...
        print(str(cantidad_con_simBP_en_intervalo(int(n_str),int(a_str), int(b_str), int(k_str))) + " enteros en ["+ a_str +","+b_str+"] tienen simBP " + k_str + " con "+ n_str)
        ...
        b_str:str = input('Ingrese b: ')
        k_str:str = input('Ingrese k: ')
        if(existe_con_simBP_en_intervalo(int(n_str), int(a_str), int(b_str), int(k_str))):
            print("En ["+a_str+","+b_str+"] hay algún entero con simBP "+k_str+" con " + n_str)
        else:
            print("En ["+a_str+","+b_str+"] no hay enteros con simBP "+k_str+" con " + n_str)

    elif opcion_seleccionada == 'D':
        n_str:str = input('Ingrese n: ')
        a_str:str = input('Ingrese a: ')
        b_str:str = input('Ingrese b: ')
        print("En ["+a_str+","+b_str+"] el entero con mayor simBP con " + n_str+" es "+str(numero_con_mayor_simBP_en_intervalo(int(n_str), int(a_str), int(b_str))))
